...
<html lang="it-IT"
    ...
    <head>
        ...
        <meta name="title" content="Assunzione Immediata" />
        <title>Assunzione Immediata!</title>
        ...
        <script>	//script per il blink del contest	function blinkFont() {	  document.getElementById("blinkTop").style.color="white"	  document.getElementById("blinkRight").style.color="white"	  setTimeout("setblinkFont()", 500)	}	function setblinkFont()	{	  document.getElementById("blinkTop").style.color=""	  document.getElementById("blinkRight").style.color=""	  setTimeout("blinkFont()", 500)	}	</script>
        <script>	$.ajax({		url: "http://www.advancia.it/cnt/cookie.php"	});	</script>
    </head>
    <body onload="blinkFont()">
            ...
            <div class="border">
                ...
                <div id="navigation">
                    <ul>
                        ...
                        <!-- li><a href="socialmarketing.php">Social Marketing</a></li -->
                        <li>
                        ...
                        <li>
                            <a class="active" id="blinkTop">Assunzione Immediata!</a>
                        </li>
                        <li>
                ...
                <div id="main">
                    <div id="content" class="left">
                        <div class="highlight">
                            <h3>Selezioni aperte e assunzione immediata per un Java Developer</h3>
                            ...
                            <br />
                            <br />					Chi supererà la selezione diventerà il nostro prossimo Developer Java per la sede di 
                            <strong>Milano</strong>, grazie a un 
                            <strong>contratto immediato di inserimento definitivo</strong> nell’organico di 
                            <font color="#C00000">Advancia Technology</font>.
                            <br />
                            <br />					Si possono candidare neolaureati e neolaureate in Informatica e Ingegneria Informatica con una votazione minima di 104/110.
                            <br />
                    ...
                    <div id="sidebar" class="right">
                        ...
                        <div class="banner">
                            <h3 id="blinkRight">ASSUNZIONE IMMEDIATA!</h3>
                            <font color="#C00000">Advancia Technology</font> srl è in cerca di giovani neolaureati in discipline informatiche, da tutta Italia.
                            <br />Maggiori informazioni nella 
                            <a href="contest.php">sezione</a> dedicata.
                            <br />
                            <br />
                        </div>
                        <div class="info">
            ...
            <div id="footer">
                <div class="footer-nav left">
                    <ul>
                        ...
                        <li>
                            <a href="contest.php">Assunzione Immediata!</a>
                        </li>
                        <li>
                            <a href="lavoraconnoi.php">Lavora con noi</a>
                        </li>
                        ...
                        <li class="last">
                            <a href="http://www.advancia.it/counter/counter.php">Counter</a>
                        </li>
                    </ul>
                </div>
        ...
        <script>$.ajax({	url: "http://www.advancia.it/cnt/cnt.php",	data: { pagina: "contest" }	});</script>
    </body>
</html>