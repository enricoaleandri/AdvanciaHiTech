...
<html lang="it-IT"
    ...
    <head>
        ...
        <meta name="description" content="Connettersi e contattare Advancia Techonology a portata di click, tramite il semplice riempimento del form specifico." />
            ...
            <div class="border">
                ...
                <div id="navigation">
                    <ul>
                        ...
                        <!-- li><a href="contest.php" id="blinkTop">Assunzione Immediata!</a></li -->
                        <li>
                ...
                <div class="slider">
                    <ul>
                        <li>
                            <div class="item">
                                <div class="text">
                                    <img style="position: absolute; top: 20px; left: 120px;" src="css/images/contattaci.png" />
                                </div>
                ...
                <div id="main">
                                                    ...
                                                    <div id="sidebar" class="right">
                                                        ...
                                                        <!-- div class="banner"><h3 id="blinkRight">ASSUNZIONE IMMEDIATA!</h3><font color="#C00000">Advancia Technology</font> srl � in cerca di giovani neolaureati in discipline informatiche, da tutta Italia.<br />Maggiori informazioni nella <a href="contest.php">sezione</a> dedicata.<br /><br /></div -->
                                                        <div class="info">
                                                            <h3>INFO</h3>
                                                            <center>
                                            ...
                                            <div id="footer">
                                                <div class="footer-nav left">
                                                    <ul>
                                                        ...
                                                        <!-- li><a href="contest.php">Assunzione Immediata!</a></li -->
                                                        <li>
                                                            <a href="lavoraconnoi.php">Lavora con noi</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <script>$.ajax({	url: "http://www.advancia.it/cnt/cnt.php",	data: { pagina: "contatti" }	});</script>
                                    </body>
                                </html>